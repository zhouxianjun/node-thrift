...
module.exports = class ZookeeperThriftServerRegister extends require('events') {
            ...
            (async () => {
                try {
                    ...
                    if (service && service.thrift && service.version) {
                        ...
                        await this.register(name, service.version, queryString.stringify(address, null, null, {encodeURIComponent: (str) => {return str;}}));
